...
if __name__ == '__main__':
    ...
    train_data = fe.read_train_Data('F:/dd/20181031_weibo/weibo_train_data.txt')
    # predict_data = fe.read_predict_data('F:/dd/20181031_weibo/weibo_predict_data.txt')
    ...
    train_data.to_csv('F:/dd/20181031_weibo/train_dataset_updated.csv')
    # predict_data.to_csv('F:/dd/20181031_weibo/predict_dataset_updated.csv')
