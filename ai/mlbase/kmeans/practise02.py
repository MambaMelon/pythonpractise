# -*- coding: utf-8 -*-
# @Time    : 2018/7/13 上午 08:58
# @Author  : melon

"""层次聚类AGNES采用不同距离计算策略的不同合并结果"""
...
if __name__ == "__main__":
    ...
    n_clusters = 4
    N = 1000
    data1, y1 = ds.make_blobs(n_samples=N, n_features=2, centers=((-1, 1), (1, 1), (1, -1), (-1, -1)), cluster_std=0.5,
                           random_state=28)
