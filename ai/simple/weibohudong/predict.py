...
if __name__ == '__main__':
    train_df = pd.read_csv('F:/dd/20181031_weibo/train_dataset_updated.csv')
    predict_df = pd.read_csv('F:/dd/20181031_weibo/predict_dataset_updated.csv')
    ...
    result.to_csv('F:/dd/20181031_weibo/result.csv')
